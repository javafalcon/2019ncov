...
def capsul_train_predict():
    (x_train, y_train), (x_test, y_test), (x_indt, y_indt) = load_data(col=9, row=9)
    model = CapsNet(input_shape=(9,10,2,),kerl=3, n_class=2, num_routing=5)
